...
public class ToetsController {
    ...
    public String nieuwToetsresultaatPost(@PathVariable int toetsId, ToetsResultaat toetsResultaat, ModelMap model) {
        ...
        model.addAttribute("succes", "Het toetsresultaat van " + toetsResultaat.getPersoonsrol().getPersoon().getVolledigeNaam() + " op de toets " + toetsResultaat.getToets().getNaam() + " is toegevoegd");
        return "Algemeen/bevestigingspagina";
    }

    // Toetsresultaat wijzigen
    ...
    public String wijzigToetsresultaatPost(@PathVariable int toetsId, @PathVariable int persoonId, @ModelAttribute("toetsresultaat") ToetsResultaat toetsResultaat, BindingResult result, ModelMap model) {
        ...
        model.addAttribute("succes", "Het toetsresultaat van " + toetsResultaatRead.getPersoonsrol().getPersoon().getVolledigeNaam() + " op de toets " + toetsResultaatRead.getToets().getNaam() + " is gewijzigd");
        return "Algemeen/bevestigingspagina";
    }
    
    // Toetsresulaat verwijderen
    @RequestMapping(value = {"/delete-toetsresultaat-{toetsId}-{persoonId}"}, method = RequestMethod.GET)
    public String verwijderToetsresultaatGet(@PathVariable int toetsId, @PathVariable int persoonId, @ModelAttribute("toetsresultaat") ToetsResultaat toetsResultaat, BindingResult result, ModelMap model) {
        ...
        return "Toetsdomein/verwijdertoetsresultaat";
    }

    @RequestMapping(value = {"/delete-toetsresultaat-{toetsId}-{persoonId}"}, method = RequestMethod.POST)
    public String verwijderToetsresultaatPost(@PathVariable int toetsId, @PathVariable int persoonId, @ModelAttribute("toetsresultaat") ToetsResultaat toetsResultaat, BindingResult result, ModelMap model) {
        ...
        toetsResultaatService.delete(toetsResultaatRead);
        model.addAttribute("succes", "Het toetsresultaat van " + toetsResultaatRead.getPersoonsrol().getPersoon().getVolledigeNaam() + " op de toets " + toetsResultaatRead.getToets().getNaam() + " is verwijderd");
